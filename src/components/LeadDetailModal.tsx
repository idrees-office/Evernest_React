...
//                                                     <div className="flex" key={comment.lead_comment_id}>
...
//                                                                     {comment?.user_name || 
//                                                                      (i > 0 ? comments[i - 1]?.user_name : 'System')}
//                                                                 </span>
...
//                                                                         {comment?.agent?.client_user_name || comment?.agent_name}
//                                                                     </span>
//                                                                 )}
//                                                             {i > 0 && (
//                                                                 <div 
...
//                                                                 <div className="bg-gray-50 dark:bg-gray-800 p-1 border-l-4 border-gray-200 dark:border-gray-600">
                                    ...
                                    <div className="flex-1 overflow-y-auto">
                                        <div className="table-responsive text-[#515365] dark:text-white-light font-semibold">
                                            <div className="max-w-[1200px] mx-auto">
                                                {comments?.map((comment, i) => (
                                                    <div className="flex" key={comment.lead_comment_id}>
                                                        <p className="text-[#3b3f5c] dark:text-white-light min-w-[150px] max-w-[180px] text-base font-semibold py-3">
                                                            {formatDate(comment.created_at)}
                                                        </p>
                                                        <div className={`
                                                            relative
                                                            ...
                                                            i % 5 === 3 ? 'before:border-danger after:border-danger' :
                                                                            'before:border-warning after:border-warning'}
                                                        `}></div>
                                                        <div className="p-3 self-center ltr:ml-3 rtl:mr-3 w-full">
                                                            <div className="flex items-center gap-3 mb-2">
                                                                <span className="text-[#3b3f5c] dark:text-white-light font-semibold text-[15px]">
                                                                    {comment?.user_name || 
                                                                     (i > 0 ? comments[i - 1]?.user_name : 'System')}
                                                                </span>
                                                                
                                                                <span 
                                                                    className="text-gray-500 dark:text-gray-400 text-[15px]"
                                                                    dangerouslySetInnerHTML={{ 
                                                                        __html: getNotesByLeadStatus(comment.lead_status) 
                                                                    }}
                                                                />
                                                                {comment.lead_status === 2 && (
                                                                    <span className="text-blue-500 dark:text-blue-400 text-[15px]">
                                                                        {comment?.agent?.client_user_name || comment?.agent_name}
                                                                    </span>
                                                                )}
                                                            {i > 0 && (
                                                            ...
                                                            {comment.lead_comment && (
                                                                <div className="bg-gray-50 dark:bg-gray-800 p-2 border-l-4 border-gray-200 dark:border-gray-600 rounded-r">
                                                                    <p className="text-[#3b3f5c] dark:text-white-light text-base italic">
                                                                        {comment.lead_comment}
                                                                    </p>
                                                                </div>
                                                            )}

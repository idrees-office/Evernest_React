...
const DashboardTable: React.FC<DashboardTableProps> = ({ columns, rows, title }) => {
    ...
    return (
        <div>
            <div className="panel mt-6">
                ...
                <DataTable records={recordsData} columns={columns} totalRecords={filteredRecords.length} recordsPerPage={pageSize} page={page} onPageChange={setPage} />
